    ...
    <footer className="footer-distributed">
        <div className="footer-left">
            ...
            <p className="footer-links">
                <a href="/">Home</a> · <d/>	
                <a href="/about-us">About Us</a> · <d/>	
                <a href="/contact-us">Contact Us</a> · <d/>	
        ...
        <div className="footer-center">
            ...
            <div>
                <svg class="icon bi bi-phone" width="3em" height="3em" viewBox="0 0 16 16" fill="white" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                <svg class="icon bi bi-envelope" width="3em" height="3em" viewBox="0 0 16 16" fill="white" xmlns="http://www.w3.org/2000/svg">
